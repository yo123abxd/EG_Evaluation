...
static py::object invoke_gpu_betweenness_centrality(py::object G, py::object weight, 
                        ...
                        py::object warp_size) {
    int warp_size_ = warp_size.cast<int>();
    Graph& G_ = G.cast<Graph&>();
    if (weight.is_none()) {
        G_.gen_CSR();
    } else {
    ...
    int gpu_r = gpu_easygraph::betweenness_centrality(V, E, *W_p, *sources, 
                                    ...
                                    endpoints.cast<py::bool_>(), BC, warp_size_);
...
py::object betweenness_centrality(py::object G, py::object weight, py::object cutoff, py::object sources, 
                                    py::object normalized, py::object endpoints, py::object warp_size) {
#ifdef EASYGRAPH_ENABLE_GPU
    return invoke_gpu_betweenness_centrality(G, weight, sources, normalized, endpoints, warp_size);
#else
